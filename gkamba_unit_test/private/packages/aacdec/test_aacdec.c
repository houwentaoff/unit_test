...
STATUS_MESSAGE StatusMessage[] = {
	...
	{AAC_DEC_INSUFFICIENT_BACKUP_MEMORY, "AAC_DEC_INSUFFICIENT_BACKUP_MEMORY"}
};
...
s8 inputBsFilename[FILENAME_MAX] = "aac_encoder.aac";		 /*!< input file */
...
s32 main(int argc, char *argv[])
{
	...
	au_aacdec_config.codec_lib_backup_addr = share_MEM1;
