...
static af_statistics_ex_t af_eng_cof1 = {
...
int custom_af_control(af_control_t* p_af_control, u16 af_tile_count, af_stat_t* p_af_info, u16 awb_tile_count, awb_data_t* p_awb_info, lens_control_t * p_lens_ctrl, ae_info_t* p_ae_info, u8 lens_runing_flag, af_stat_t* p_af_info_rgb){
	if(lens_runing_flag){
	}else{
		if (first_flag){
			first_flag = 0;
