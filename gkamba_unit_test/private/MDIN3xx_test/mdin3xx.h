...
extern ROMDATA MDIN_SRCVIDEO_ATTB defMDINSrcVideo_960[];
extern ROMDATA MDIN_OUTVIDEO_ATTB defMDINOutVideo_960[];
...
MDIN_ERROR_t MDINAUX_SetOut4CH_OutQuad(int output_mode);	// 01Aug2011
MDIN_ERROR_t MDINAUX_SetOut4CH_OutBT656(int output_mode);	// 01Aug2011
